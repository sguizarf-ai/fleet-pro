...
export default function App() {
  ...
  return (
    <>
      ...
      {modal?.type === "doc" && <DocModal key={modal.data?.id || modal._ts || "new-doc"} doc={modal.data} units={units} drivers={drivers} onSave={d => { const clean = JSON.parse(JSON.stringify({...d, id: d.id || uid()})); DoC.save(clean); }} onClose={() => setModal(null)} />}
